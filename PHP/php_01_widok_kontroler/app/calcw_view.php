...
<form action="<?php print(_APP_URL);?>/app/calcw.php" method="post">
	...
	<td><input id="id_x" type="text" name="kwota" value="<?php if (isset($kwota)) print($kwota); ?>" /></td>
	</tr><tr>
	<td><label for="id_y">Na ile lat: </label></td>
	<td><input id="id_y" type="text" name="czas" value="<?php if (isset($czas)) print($czas); ?>" /></td>
	</tr><tr>	
	<td><label for="id_op">Oprocentowanie: </label></td>
	<td><input id="id_op" type="text" name="oprocentowanie" value="<?php if (isset($oprocentowanie)) print($oprocentowanie); ?>" /></td>
	</tr>
